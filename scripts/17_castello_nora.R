...
# Read your DEG file 
my <- read_excel("./supplimentary_files/ST_6_DEGs_VU1_vs_VU2.xlsx")
...
castello <- castello %>%
  dplyr::filter(Treatment == "Nora" & DPE == "12")  ## 1, 12, 52
...
# Create logical significance flags
...
# Build 2×2 contingency matrix manually
...
# Plot contingency table (numbers only)
