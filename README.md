...
- Figure 1c, d, e and Figure 2a, Supplementary figure S4, S5, S7, S20, S23.
...
- Figure 3a, Supplementary figure S18, S19.
...
- Figure 3b, Supplementary figure S18, S19, S22, S23, S24.
...
- Figure 4a, Supplementary figure S34.
...
- Figure 4b, Supplementary figure S35.
...
- Figure 5, 6, Supplementary figure 36, 37.
...
15_bacterial_samples_analysis.R

- Comparison of infection rate and viral load of Nora and Drosophila A virus between bacterial uninfected and infected samples in the fat body.
- Supplementary figure S16.

16_castello_DAV.R and 17_castello_nora.R

- Comparison of differentially expressed genes in Nora and Drosophila A virus infection with a published bulk RNA-seq study (Castelló-Sanjuán et al., 2025).
- Supplementary figure S33 (b, b').
- Supplementary figure S33 (a, a').

18_pseudo_replication_random_suffle.R

- Permutation-based assessment of pseudo-replication effect in differential gene expression analysis.
- Supplementary figure S22.

19_soupx.R

- Viral tropism comparison with and without SoupX ambient RNA contamination correction.
- Supplementary figure S6.

20_survey_NV_DAV.R

- Analysis of publicly available bulk fat body RNAseq data to screen Nora and Drosophila A virus.
- Supplementary figure S3.

21_viral_reads_split_based_coinfection.R

- Viral titer comparison in single versus coinfected cells in mated flies.
- Supplementary figure S15.

22_without_harmony_integration.R

- Comparison of differentially expressed genes with and without Harmony based replicate integration in Nora and Drosophila A virus infections.
...
viral_cov_RPM100_fatbody.tsv

- Publicly available bulk RNA-seq samples with Nora virus and Drosophila A virus abundances exceeding 100 RPM (reads per million), identified from a screen of 1,555 NCBI SRA samples across 81 BioProjects.

pbio.3003437.s003.xlsx

- Results of Castelló-Sanjuán et al., 2025 bulk RNA-seq study.
